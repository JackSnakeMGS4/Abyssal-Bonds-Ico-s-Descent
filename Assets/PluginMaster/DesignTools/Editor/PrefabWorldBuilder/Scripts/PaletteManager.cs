...
namespace PluginMaster
{
    ...
    public class BrushSettings : ISerializationCallbackReceiver
    {
        ...
        public Texture2D thumbnail
        {
            get
            {
                ...
                if (_thumbnail == null) UpdateThumbnail(true);
                return _thumbnail;
            }
        }
        ...
        public void UpdateThumbnail(bool updateItemThumbnails) => ThumbnailUtils.UpdateThumbnail(this, updateItemThumbnails);
    ...
    public class PaletteData
    {
        ...
        {
            foreach (var brush in _brushes) brush.UpdateThumbnail(true);
        }
    ...
    public class PaletteManager : ISerializationCallbackReceiver
    {
        ...
        {
            foreach (var idx in instance._idxSelection) selectedPalette.GetBrush(idx).UpdateThumbnail(true);
        }
